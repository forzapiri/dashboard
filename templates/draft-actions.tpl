<form action="/admin/{$obj->chunkable()}" method="post" style="float: left;" class="norexui_addedit">
  <input type="hidden" name="section" value="{$obj->getObjectType()}" />
...
<form action="/admin/{$obj->chunkable()}" method="post" style="float: left;" class="norexui_draftdelete">
  <input type="hidden" name="section" value="{$obj->getObjectType()}" />
  <input type="hidden" name="action" value="chunk_revertdrafts" />
  <input type="hidden" name="id" value="{$id}" />
  <input type="image" src="/images/admin/cross.png" />
</form>
<form action="/admin/{$obj->chunkable()}" method="post" style="float: left;" class="norexui_draftlive">
  <input type="hidden" name="section" value="{$obj->getObjectType()}" />
