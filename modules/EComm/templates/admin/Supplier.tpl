...
<h3>Here, you can manage the suppliers</h3>
<a href="/admin/EComm&section=Supplier&action=addedit">Add a new supplier</a>
	...
	<tr class="{cycle values="row1,row2"}">
		...
		<td>
			<form method="POST" action="/admin/EComm" style="float: left;">
				<input type="hidden" name="supplier_id" value="{$obj->getId()}" />
				<input type="hidden" name="section" value="Supplier" />
