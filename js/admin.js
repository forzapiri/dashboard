...
function initRTE(mode, theme, name, stylesheet, bodyId, bodyClass) {
	...
	tinyMCE.init({
		...
		theme_advanced_buttons1:"bold,italic,underline,strikethrough,|,bullist,blockquote,|,justifyleft,justifycenter,justifyright,justifyfull,|,link,unlink,|,fullscreen,|,formatselect,|,showhide", 
		theme_advanced_buttons2:"code,|,forecolor,|,pastetext,pasteword,removeformat,|,image,media,charmap,numlist,|,outdent,indent,|,undo,redo", 
